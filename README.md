...
| [`hep-to-adl/`](hep-to-adl/) | **Agent Plugin** — convert HEP analysis code (C++/Python/…) into ADL for smash2 / CutLang. Skills and fixtures only; not a smash2 change. | [`hep-to-adl/README.md`](hep-to-adl/README.md) |

Agents that need to turn CMSSW, NanoAOD, coffea, or Delphes selection code into ADL should load [`hep-to-adl/`](hep-to-adl/) (Cursor / Claude Code / Codex skills). The plugin fills a `HepToAdlDraft` and emits tutorial-style ADL. It does not change smash2. Install and validate notes live in [`hep-to-adl/README.md`](hep-to-adl/README.md).
