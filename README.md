...
| [`cpp/`](cpp/) | **ADL2 C++ port** — modular libs mirroring smash2 (P1 syntax, P2 sema/HIR, P3 interp/formula/axioms); not a rewrite of `legacy_parser/` | [`cpp/README.md`](cpp/README.md) |
