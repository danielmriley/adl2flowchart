...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_VAR = 268,                 // VAR
    TOK_PLUS = 269,                // PLUS
    TOK_SUBTRACT = 270,            // SUBTRACT
    TOK_MULTIPLY = 271,            // MULTIPLY
    TOK_DIVIDE = 272,              // DIVIDE
    TOK_ASSIGN = 273,              // ASSIGN
    TOK_GT = 274,                  // GT
    TOK_LT = 275,                  // LT
    TOK_GE = 276,                  // GE
    TOK_LE = 277,                  // LE
    ...
    TOK_NOT = 282,                 // NOT
    TOK_PIPE = 283,                // PIPE
    TOK_LBRACKET = 284,            // LBRACKET
    TOK_RBRACKET = 285,            // RBRACKET
    TOK_COLON = 286,               // COLON
    TOK_QUES = 287,                // QUES
    TOK_COMMA = 288,               // COMMA
    TOK_DOT = 289,                 // DOT
    TOK_INCLUSIVE = 290,           // INCLUSIVE
    TOK_EXCLUSIVE = 291,           // EXCLUSIVE
    TOK_INT = 292,                 // INT
    TOK_REAL = 293                 // REAL
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_COMMA = 33,                            // COMMA
        S_DOT = 34,                              // DOT
        S_INCLUSIVE = 35,                        // INCLUSIVE
        S_EXCLUSIVE = 36,                        // EXCLUSIVE
        S_INT = 37,                              // INT
        S_REAL = 38,                             // REAL
        S_YYACCEPT = 39,                         // $accept
        S_start = 40,                            // start
        S_objects = 41,                          // objects
        S_definitions = 42,                      // definitions
        S_regions = 43,                          // regions
        S_definition = 44,                       // definition
        S_function = 45,                         // function
        S_param_list = 46,                       // param_list
        S_object_block = 47,                     // object_block
        S_takes = 48,                            // takes
        S_take = 49,                             // take
        S_take_id = 50,                          // take_id
        S_id_list = 51,                          // id_list
        S_id_list_params = 52,                   // id_list_params
        S_region_block = 53,                     // region_block
        S_criteria = 54,                         // criteria
        S_criterion = 55,                        // criterion
        S_chained_cond = 56,                     // chained_cond
        S_chain = 57,                            // chain
        S_condition = 58,                        // condition
        S_compare_op = 59,                       // compare_op
        S_logic_op = 60,                         // logic_op
        S_expr = 61,                             // expr
        S_expr_op = 62,                          // expr_op
        S_factor = 63,                           // factor
        S_factor_op = 64,                        // factor_op
        S_term = 65,                             // term
        S_id_qualifiers = 66,                    // id_qualifiers
        S_id_qualifier = 67,                     // id_qualifier
        S_dot_op = 68,                           // dot_op
        S_range = 69,                            // range
        S_int = 70,                              // int
        S_real = 71,                             // real
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::TOK_DEFINE <= tok && tok <= token::TOK_EXCLUSIVE));
#endif
      }
    };
