# adl-ingest fixture provenance (C++ copy)

Standalone copies of the Delphes/NanoAOD fixtures. C++ ingest tests read
this directory; they do not reach into `reimplementation/`.
