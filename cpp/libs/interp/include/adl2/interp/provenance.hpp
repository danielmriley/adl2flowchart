...
/// SPEC_EVENT_PIPELINE §6 provenance object. Same field order as smash2.
/// Tool identity for this binary is `smash2_cpp 0.1.0` (not dump-identical
/// to smash2's `smash2 0.1.0`).
