...
/// Recursive-descent parser (ADR-002 / ADR-010 / ADR-011).
/// One `parse_<nonterminal>` per major production in grammar.ebnf.
/// Mechanical expression-ladder and Choice-dispatch bodies are generated
/// by `adl2_rdgen`; hooks (indent, bins, path-token, …) stay hand-written.
/// See RDGEN.md.
...
class Parser {
 ...
 private:
  ...
  bool is_cut_keyword() const;
  bool is_reject_keyword() const;
