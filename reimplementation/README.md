...
[`adl2/`](adl2/)). Design specs, plans, and reports are archived under
...
| Doc | Contents |
|---|---|
| [SPEC_LANGUAGE.md](../docs/archive/specs/SPEC_LANGUAGE.md) | Lexical rules, EBNF grammar, semantics, the checked fragment, open semantic questions |
| [SPEC_ARCHITECTURE.md](../docs/archive/specs/SPEC_ARCHITECTURE.md) | Crate layout, pipeline, the Quantity model, polarity-typed formula IR, solver interface |
| [SPEC_ANALYSIS.md](../docs/archive/specs/SPEC_ANALYSIS.md) | Verdict definitions, encoding rules, axiom catalog, outputs, cross-file design |
| [TESTING.md](../docs/archive/specs/TESTING.md) | Oracle strategy, property-based/differential/metamorphic testing, CI |
| [PLAN.md](../docs/archive/specs/PLAN.md) | Phases, exit criteria, parity gate, risks, estimates |
| [DECISIONS.md](../docs/archive/specs/DECISIONS.md) | ADRs: language, parser, identity, solver, fragment posture — each tied to the legacy bug that motivated it |
...
# The `smash2` toolchain — build, run, features
...
New here? Start with [docs/QUICKSTART.md](../docs/archive/adl2/QUICKSTART.md) — a 5-minute
...
(`../docs/archive/specs/PARITY_DRAFT.md`).
...
[`MULTIFILE_PLAN.md`](../docs/archive/adl2/MULTIFILE_PLAN.md)). Cross runs additionally
...
[`PIPELINE_REPORT.md`](../docs/archive/adl2/PIPELINE_REPORT.md).
...
parser — one function per grammar rule in `../docs/archive/specs/SPEC_LANGUAGE.md` §3, so
...
build, see `../docs/archive/adl2/COUNTEREXAMPLES.md`), a metamorphic suite checks invariances
...
A Farkas certificate proves that *the encoded formula* is
real-unsatisfiable. It removes solver search from the trusted base — it
does not, by itself, prove that two ADL regions are disjoint in the
interpreter's sense. What a PROVEN DISJOINT still trusts, and what audits
each piece:
...
- **A new encodable construct**: extend the encoder in `adl-formula`
  following the table in `../docs/archive/specs/SPEC_ANALYSIS.md` §1. The rule: encode
...
Specs and design records are archived in `../docs/archive/specs/`: `../docs/archive/specs/SPEC_LANGUAGE.md`,
`../docs/archive/specs/SPEC_ARCHITECTURE.md`, `../docs/archive/specs/SPEC_ANALYSIS.md`, `../docs/archive/specs/TESTING.md`,
`../docs/archive/specs/DECISIONS.md` (ADRs tied to the legacy bugs that motivated them),
`../docs/archive/specs/PHASE0_RESOLUTIONS.md` (current answers to the open semantic
questions), `../docs/archive/specs/PARITY_DRAFT.md`, `../docs/archive/specs/SPEC_EVENT_PIPELINE.md` (Phase 10).
Build history lives in `../docs/archive/adl2/`: `BUILD_NOTES.md`, `BUILD_REPORT.md`, `COUNTEREXAMPLES.md`,
...
# env-gated oracles (need .venv-uproot on PATH; see ../docs/archive/adl2/BUILD_NOTES.md):
...
- Some semantic questions remain pinned to convention-neutral defaults
  ...
  convention, `~=`, and size aliases — see `../docs/archive/specs/PHASE0_RESOLUTIONS.md`;
