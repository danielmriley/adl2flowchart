...
# diagnostics through `smash3 check` (adl-syntax parser + adl-sema resolver).
...
echo "corpus_gate: building smash3..."
cargo build -q --manifest-path "$workspace/Cargo.toml" -p adl-cli
smash3="$workspace/target/debug/smash3"
